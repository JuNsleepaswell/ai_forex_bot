...
# --- CONFIGURATION ---
TICKERS = ['XAUUSD'] # For testing, we focus on Gold (XAUUSD). Add more as needed. Must match WFO and Models.
...
# --- AI THRESHOLDS ---
CONFIDENCE_THRESHOLD = 0.63 # Matched to your successful backtest
SL_MULTIPLIER = 1.5         # Matched to backtest
TP_MULTIPLIER = 3.0         # Matched to backuuutest (2:1 Ratio)
ADX_THRESHOLD = 25          # Chop Filter
...
def get_live_features(trade_symbol):
    ...
    df_m15.rename(columns={'open': 'Open', 'high': 'High', 'low': 'Low', 'close': 'Close', 'tick_volume': 'Volume'},
                  inplace=True)
